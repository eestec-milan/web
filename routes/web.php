...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/events', [EventsController::class, 'get'])->name('events');
    //Route::post('/events/create', [EventsController::class, 'save']);
    Route::delete('/events/{id}', [EventsController::class, 'delete'])->name('event.delete');
    ...
    Route::post('/meetings', [MeetingController::class, 'get'])->name('dashboard.meetings');
    ...
    Route::get('/members/attendances/{memberId}', [MemberController::class, 'getMemberAttendances'])->name('getMemberAttendances');
    Route::post('/members', [MemberController::class, 'get'])->name('dashboard.users');
