...
@section('content')
    <div class="flex w-4/5 justify-right mx-20 ml-96 items-center h-1/2">
        <div class="bg-white p-6 mx-20 my-32 rounded-md w-full">
            ...
            @endif
            <form action = "{{route('meetings.create')}}" method="POST" class="pl-4 w-full">
                @csrf
                <div class="md:flex md:justify-items-start mb-6">
                    ...
                    <div class="md:w-full">
                        <input name = "meeting_date" type="date" class="bg-white appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" placeholder="Insert...">
                    </div>
                </div>
